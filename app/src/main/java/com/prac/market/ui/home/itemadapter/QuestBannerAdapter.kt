...
class QuestBannerAdapter : ListAdapter<Banner, QuestBannerAdapter.HomeBannerViewHolder>(
    BannerDiffCallBack()
) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeBannerViewHolder {
        val binding = ItemDailyQuestBinding.inflate(LayoutInflater.from(parent.context), parent, false)
